  ...
  useEffect(() => {
    const calculateTotalEarnings = async () => {
      ...
      for (const product of allProducts) {
        try {
          const response = await axios.get(`http://localhost:8080/checkouts/earnings/${product.id}`);
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="pt-3 d-flex flex-row gap-2">
                    <button className="bg-primary" onClick={() => navigate(`/storedetails/${product.id}`)}>
                      View
                    </button>
                    ...
                    <button className="bg-danger" onClick={() => handleDelete(product.id)}>
                      Delete
                    </button>
                  </div>
                </div>
